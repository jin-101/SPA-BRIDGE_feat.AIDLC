...
const commandNameArbitrary = fc.constantFrom<CliCommandName>('convert', 'validate', 'report', 'help');
const verbosityArbitrary = fc.constantFrom<CliVerbosity>('quiet', 'normal', 'verbose');
const reportFormatArbitrary = fc.constantFrom<CliReportFormat>('json', 'markdown', 'html');
