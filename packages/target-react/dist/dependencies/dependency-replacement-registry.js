export const dependencyReplacementRules = [
    {
        sourcePackage: '@wds/wc-angular-lib',
        targetPackage: '@wds/wc-react-lib',
        versionPolicy: 'preserve',
        rationale: 'Custom WDS Angular package has a React package counterpart. Package replacement is deterministic, but usage-site API compatibility must be reviewed.',
        usageSiteReviewPolicy: 'when-unverified',
    },
];
export const dependencyRemovalRules = [
    {
        pattern: /^@angular\//,
...
export const highRiskWrapperRules = [
    {
        pattern: /^ngx-/,
...
//# sourceMappingURL=dependency-replacement-registry.js.map