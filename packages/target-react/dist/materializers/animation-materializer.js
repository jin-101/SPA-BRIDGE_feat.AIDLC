...
export class AnimationMaterializer {
    materialize(animations, sourceRefs = []) {
        ...
        const helperFiles = animations.map((animation) => createFileSpec({
...
//# sourceMappingURL=animation-materializer.js.map