import type { DependencyCompatibilityDecision, DependencyCompatibilityReport, GeneratedFileSpec } from '../types.js';
import { createFileSpec } from '../write-plan/generated-file-spec-factory.js';

const sectionTitle = (title: string): string => `## ${title}\n`;

const renderDecisionRows = (decisions: DependencyCompatibilityDecision[]): string => {
...
export class DependencyCompatibilityReportMaterializer {
  materialize(report: DependencyCompatibilityReport): GeneratedFileSpec {
