...
export class SecurityEvaluationPipeline {
    configResolver = new SecurityConfigResolver();
    detector = new SensitiveDataDetector();
    merger = new FindingMerger();
    policyGate = new ProviderPolicyGate();
    auditBuilder = new SafeAuditEventBuilder();
    accessEvaluator = new AccessControlHookEvaluator();
    evaluate(input) {
...
//# sourceMappingURL=security-evaluation-pipeline.js.map