...
export const reportTraceLinkArbitrary = fc.record({
    id: safeTextArbitrary,
    source: safeSourceRefArbitrary,
    target: fc.oneof(fc.record({
        kind: fc.constant('ir'),
        id: safeTextArbitrary,
...
export const reportDiagnosticArbitrary = fc.record({
    id: safeTextArbitrary,
    ...
    reviewCategory: fc.option(fc.constantFrom('mapping', 'security', 'quality', 'provider', 'target-generation', 'reporting', 'source-analysis', 'transformation', 'unknown'), { nil: undefined }),
});
export const manualReviewItemArbitrary = fc.record({
    id: safeTextArbitrary,
    severity: fc.constantFrom('critical', 'blocking', 'warning', 'info'),
...
export const aiDecisionArbitrary = fc.record({
    id: safeTextArbitrary,
...
export const reportMetadataArbitrary = fc.record({
...
export const reportQualitySectionArbitrary = fc.record({
    gateStatus: fc.constantFrom('passed', 'failed', 'skipped', 'blocked'),
    gateRuns: fc.array(fc.record({
...
export const reportTraceabilitySectionArbitrary = fc.record({
...
export const reportInputBundleArbitrary = fc.record({
...
export const reportGenerationRequestArbitrary = fc.record({
    inputBundle: reportInputBundleArbitrary,
    requestedFormats: fc.shuffledSubarray(['json', 'markdown', 'html'], { minLength: 1, maxLength: 3 }),
    rendererVersion: safeTextArbitrary,
    generatedAt: fc.constant('2026-06-07T00:00:00.000Z'),
    qualityTargetPercent: fc.integer({ min: 0, max: 100 }),
    partial: fc.boolean(),
});
export const canonicalConversionReportArbitrary = fc.record({
    ...
    exportMetadata: fc.record({
        formats: fc.shuffledSubarray(['json', 'markdown', 'html'], { minLength: 1, maxLength: 3 }),
        contentHashes: fc.array(fc.record({
...
export const reportViewModelArbitrary = fc.record({
    reportId: safeTextArbitrary,
    metadata: reportMetadataArbitrary,
    sections: fc.record({
