...
export const validateCanonicalConversionReport = (input: unknown): Result<unknown, ReportError> => {
...
export const validateReportExportSet = (input: unknown): Result<unknown, ReportError> => {
