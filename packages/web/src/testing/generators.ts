...
import {
  canonicalConversionReportArbitrary,
  manualReviewItemArbitrary,
  reportDiagnosticArbitrary,
} from '@spa-bridge/core-reporting';
...
export const webReviewRoleArbitrary: fc.Arbitrary<WebReviewRole> = fc.constantFrom('guest', 'viewer', 'reviewer', 'approver', 'admin');
export const webReviewTabArbitrary: fc.Arbitrary<WebReviewTab> = fc.constantFrom('dashboard', 'reports', 'triage', 'quality', 'security');

export const webReviewInputArbitrary: fc.Arbitrary<WebReviewInput> = fc.record({
...
export const remediationRequestArbitrary: fc.Arbitrary<WebRemediationRequest> = fc.record({
