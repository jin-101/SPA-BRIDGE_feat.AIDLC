...
import {
  ProviderErrorSchema,
  TargetCapabilityPackSchema,
  type ProviderCapability,
  type ProviderCapabilityCategory,
  type ProviderError,
...
export const defaultCapabilityCatalog: ReadonlyArray<ProviderCapability> = [
...
export const getCapabilityTemplate = (category: ProviderCapabilityCategory): ProviderCapability | undefined =>
  defaultCapabilityCatalog.find((entry) => entry.category === category);

export const createTargetCapabilityPack = (
  input: TargetCapabilityPack,
): Result<TargetCapabilityPack, ProviderError> => {
