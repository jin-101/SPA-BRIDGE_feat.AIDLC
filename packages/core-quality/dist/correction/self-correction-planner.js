...
export class SelfCorrectionPlanner {
    candidateFactory;
    constructor(candidateFactory = new CorrectionCandidateFactory()) {
        this.candidateFactory = candidateFactory;
    }
    plan(gate, gateRun, policy) {
    ...
    ensureCanCorrect(gate, gateRun, policy) {
        if (!gate.blocking) {
...
//# sourceMappingURL=self-correction-planner.js.map