    ...
    convert(context) {
        ...
        const templateDrafts = context.templates.map((template) => {
            ...
            if (unsupported.length > 0) {
                ...
                mappingRequests.push(this.mappingBuilder.build('template', template.sourceRef ? [template.sourceRef] : [], [this.ids.artifactRef(`${template.id}/template.json`, 'template')], ['template-unsupported-reference'], [review.diagnostic.code], {
...
//# sourceMappingURL=template-converter.js.map